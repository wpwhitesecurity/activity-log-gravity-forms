	...
	__( 'Gravity Forms', 'wp-security-audit-log' ) => array(
		__( 'Monitor Gravity Forms', 'wp-security-audit-log' ) => array(
			...
			array(
				...
				__( 'Form name %form_name% %LineBreak% Form ID: %PostID% %LineBreak% %EditorLinkForm%', 'wp-security-audit-log' ),
				'gravityforms_forms',
				'created',
			),
			...
			array(
				...
				__( 'Setting name %setting_name% %LineBreak% Setting value %setting_value% %LineBreak% Form name %form_name% %LineBreak% Form ID: %PostID% %LineBreak% %EditorLinkForm%', 'wp-security-audit-log' ),
				'gravityforms_forms',
				'enabled',
			),
			...
			array(
				...
				__( 'Form name %form_name% %LineBreak% Form ID: %PostID% %LineBreak% Confirmation name: %confirmation_name% %LineBreak% Confirmation type: %confirmation_type% %LineBreak% Confirmation message %confirmation_message% %LineBreak% %EditorLinkForm%', 'wp-security-audit-log' ),
			...
			array(
				...
				__( 'Form name %form_name% %LineBreak% Form ID: %PostID% %LineBreak% Notification name: %notification_name% %LineBreak% %EditorLinkForm%', 'wp-security-audit-log' ),
			...
			array(
				...
				__( 'Entry title %entry_title% %LineBreak% Form name %form_name% %LineBreak% Form ID: %PostID% %LineBreak% %EditorLinkForm%', 'wp-security-audit-log' ),
			...
			array(
				...
				__( 'A form entry was moved to trash %LineBreak% Entry title %entry_title% %LineBreak% Form name %form_name% %LineBreak% Form ID: %PostID% %LineBreak% %EditorLinkForm%', 'wp-security-audit-log' ),
				'gravityforms_entries',
				'read',
			),
			...
			array(
				...
				__( 'A form entry was permanently deleted %LineBreak% Entry title %entry_title% %LineBreak% Form name %form_name% %LineBreak% Form ID: %PostID% %LineBreak% %EditorLinkForm%', 'wp-security-audit-log' ),
				'gravityforms_entries',
				'read',
			),
			...
			array(
				...
				__( 'Form name %form_name% %LineBreak% Form ID: %PostID% %LineBreak% Entry title %entry_title% %LineBreak% %EditorLinkForm%', 'wp-security-audit-log' ),
				'gravityforms_entries',
				'read',
			),
