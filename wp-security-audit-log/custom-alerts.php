	...
	__( 'Gravity Forms', 'wp-security-audit-log' ) => array(
		__( 'Monitor Gravity Forms', 'wp-security-audit-log' ) => array(
			...
			array(
				...
				__( 'Entry title %entry_title% %LineBreak% Form name %form_name% %LineBreak% Form ID: %form_id% %LineBreak% %EditorLinkForm%', 'wp-security-audit-log' ),
			...
			array(
				...
				__( 'A form entry was moved to trash %LineBreak% Entry title %entry_title% %LineBreak% Form name %form_name% %LineBreak% Form ID: %form_id% %LineBreak% %EditorLinkForm%', 'wp-security-audit-log' ),
				'gravityforms_entries',
				'read',
			),
			...
			array(
				...
				__( 'A form entry was permanently deleted %LineBreak% Entry title %entry_title% %LineBreak% Form name %form_name% %LineBreak% Form ID: %form_id% %LineBreak% %EditorLinkForm%', 'wp-security-audit-log' ),
				'gravityforms_entries',
				'read',
			),
			...
			array(
				...
				__( 'Form name %form_name% %LineBreak% Form ID: %form_id% %LineBreak% Entry title %entry_title% %LineBreak% %EditorLinkForm%', 'wp-security-audit-log' ),
				'gravityforms_entries',
				'read',
			),
			...
			array(
				...
				__( 'Field name %field_name% %LineBreak% Form name %form_name% %LineBreak% Form ID: %form_id% %LineBreak% %EditorLinkForm%', 'wp-security-audit-log' ),
				'gravityforms_notifications',
				'created',
			),
